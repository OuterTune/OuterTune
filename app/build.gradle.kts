...
// build variants and stuff
    ...
    aboutLibraries {
        ...
        license {
            ...
            allowedLicenses.addAll("Apache-2.0", "BSD-3-Clause", "GNU LESSER GENERAL PUBLIC LICENSE, Version 2.1", "GPL-3.0-only", "GPL-3.0", "GNU GENERAL PUBLIC LICENSE, Version 3", "EPL-2.0", "MIT", "MPL-2.0", "Public Domain")
