...
object YTPlayerUtils {
     ...
     * TVHTML5_SIMPLY_EMBEDDED_PLAYER uses signature timestamps (no JS deobfuscation needed)
     * and provides stable streams for logged-in users.
     * IOS is kept as last resort but produces 403 errors after ~30 seconds.
     */
