...
fun ConnectScreen(
    ...
    val createOptions = listOf(
        CreateOption(
            title = "OuterConnect",
            subtitle = "Listen with friends in real-time",
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                ...
                Text(
                    text = "Choose an option to create something new or connect with others:",
